...
export default function CandidateDashboard({
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden">
      {/* Header */}
      <div className="p-4 pb-3 flex-shrink-0 border-b" style={{ borderColor: 'rgba(255, 255, 255, 0.5)' }}>
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-semibold" style={{ color: 'var(--text-primary)' }}>Candidate Dashboard</h1>
      ...
      <div className="p-4 pb-3 flex-shrink-0">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-full border focus:ring-2 focus:outline-none text-sm"
            style={{
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-4 min-h-0">
        ...
        >
          <table className="w-full">
            <thead style={{ background: 'rgba(255, 255, 255, 0.5)', borderBottom: '1px solid rgba(255, 255, 255, 0.5)' }}>
              <tr>
                <th
                  className="text-left py-3 px-4 text-[10px] font-semibold uppercase tracking-wider cursor-pointer transition-colors"
                  style={{ color: 'var(--text-secondary)' }}
                ...
                <th className="text-left py-3 px-4 text-[10px] font-semibold uppercase tracking-wider" style={{ color: 'var(--text-secondary)' }}>
                  Actions
                </th>
              </tr>
            </thead>
                    ...
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-1.5">
                        <button
                          ...
                          className="px-2 py-1 text-[10px] hover:bg-white/50 rounded-md transition-colors"
                          style={{ color: 'var(--text-secondary)' }}
